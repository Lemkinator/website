...
Both: full-bleed, edge-to-edge content, with no padding/letterboxing/empty-background "sticker" look.
...
`focalPosition="center 20%"`), which also swaps it to a narrow parallax swing centered on that
